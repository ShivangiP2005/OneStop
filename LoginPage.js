...
const LoginPage = () => {
  ...
  try {
    ...
    navigate('/dashboard'); // keep your existing route
  } catch (err) {
  ...
  return (
    <div className="min-h-screen bg-[#020617] flex items-center justify-center px-6 py-12">
      <div className="bg-white/5 backdrop-blur-xl border border-white/10 shadow-2xl rounded-2xl p-8 max-w-md w-full" data-testid="login-card">
        ...
        <h2 className="font-manrope font-bold text-3xl text-white text-center mb-2" data-testid="login-title">Welcome Back</h2>
        <p className="text-slate-400 text-center mb-6">Sign in to access your dashboard</p>
        
        {error && (
          <div className="bg-red-500/10 border border-red-500/50 text-red-400 px-4 py-2 rounded-lg mb-4" data-testid="login-error">
            {error}
          </div>
        )}
